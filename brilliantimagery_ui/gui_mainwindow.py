...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self._1280x720 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons = QButtonGroup(MainWindow)
        self.resolution_buttons.setObjectName(u"resolution_buttons")
        self.resolution_buttons.addButton(self._1280x720)
        self._1280x720.setObjectName(u"_1280x720")

        self.gridLayout_4.addWidget(self._1280x720, 0, 0, 1, 1)

        self._2048x1080 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._2048x1080)
        self._2048x1080.setObjectName(u"_2048x1080")

        self.gridLayout_4.addWidget(self._2048x1080, 0, 2, 1, 1)

        self._3000x2000 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._3000x2000)
        self._3000x2000.setObjectName(u"_3000x2000")

        self.gridLayout_4.addWidget(self._3000x2000, 1, 0, 1, 1)

        self._3840x2160 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._3840x2160)
        self._3840x2160.setObjectName(u"_3840x2160")
        self._3840x2160.setChecked(True)

        self.gridLayout_4.addWidget(self._3840x2160, 1, 1, 1, 1)

        self._4960x2160 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._4960x2160)
        self._4960x2160.setObjectName(u"_4960x2160")

        self.gridLayout_4.addWidget(self._4960x2160, 1, 2, 1, 1)

        self._1920x1080 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._1920x1080)
        self._1920x1080.setObjectName(u"_1920x1080")

        self.gridLayout_4.addWidget(self._1920x1080, 0, 1, 1, 1)

        self._6144x3160 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._6144x3160)
        self._6144x3160.setObjectName(u"_6144x3160")

        self.gridLayout_4.addWidget(self._6144x3160, 2, 0, 1, 1)

        self._7680x4320 = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self._7680x4320)
        self._7680x4320.setObjectName(u"_7680x4320")

        self.gridLayout_4.addWidget(self._7680x4320, 2, 1, 1, 1)

        self.source_res = QRadioButton(self.gridLayoutWidget_3)
        self.resolution_buttons.addButton(self.source_res)
        ...
        self.watch_render_button.setGeometry(QRect(520, 290, 111, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self._1280x720.setText(QCoreApplication.translate("MainWindow", u"720p", None))
        self._2048x1080.setText(QCoreApplication.translate("MainWindow", u"2K", None))
        self._3000x2000.setText(QCoreApplication.translate("MainWindow", u"3K", None))
        self._3840x2160.setText(QCoreApplication.translate("MainWindow", u"4K UHD", None))
        self._4960x2160.setText(QCoreApplication.translate("MainWindow", u"DCI 4K", None))
        self._1920x1080.setText(QCoreApplication.translate("MainWindow", u"1080p", None))
        self._6144x3160.setText(QCoreApplication.translate("MainWindow", u"6K", None))
        self._7680x4320.setText(QCoreApplication.translate("MainWindow", u"8K", None))
