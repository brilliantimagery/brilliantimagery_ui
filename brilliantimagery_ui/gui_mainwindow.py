...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.image_count_edit.sizePolicy().hasHeightForWidth())
        self.image_count_edit.setSizePolicy(sizePolicy2)
        ...
        self.rendered_format_edit = QLineEdit(self.gridLayoutWidget)
        self.rendered_format_edit.setObjectName(u"rendered_format_edit")
        sizePolicy2.setHeightForWidth(self.rendered_format_edit.sizePolicy().hasHeightForWidth())
        self.rendered_format_edit.setSizePolicy(sizePolicy2)
        self.rendered_format_edit.setMinimumSize(QSize(0, 0))
        self.rendered_format_edit.setMaximumSize(QSize(50, 16777215))

        self.horizontalLayout_4.addWidget(self.rendered_format_edit)
        ...
        self.groupBox_5.setGeometry(QRect(230, 310, 221, 71))
        self.alpha = QCheckBox(self.groupBox_5)
        self.alpha.setObjectName(u"alpha")
        self.alpha.setGeometry(QRect(10, 40, 91, 17))
        self.color_10_bit = QCheckBox(self.groupBox_5)
        self.color_10_bit.setObjectName(u"color_10_bit")
        self.color_10_bit.setGeometry(QRect(110, 40, 91, 17))
        self.gridLayoutWidget_5 = QWidget(self.groupBox_5)
        self.gridLayoutWidget_5.setObjectName(u"gridLayoutWidget_5")
        self.gridLayoutWidget_5.setGeometry(QRect(10, 10, 211, 31))
        self.gridLayout_6 = QGridLayout(self.gridLayoutWidget_5)
        self.gridLayout_6.setObjectName(u"gridLayout_6")
        self.gridLayout_6.setContentsMargins(0, 0, 0, 0)
        self.pf_420 = QRadioButton(self.gridLayoutWidget_5)
        self.pixel_format_buttons = QButtonGroup(MainWindow)
        self.pixel_format_buttons.setObjectName(u"pixel_format_buttons")
        self.pixel_format_buttons.addButton(self.pf_420)
        self.pf_420.setObjectName(u"pf_420")
        self.pf_420.setChecked(False)

        self.gridLayout_6.addWidget(self.pf_420, 0, 0, 1, 1)

        self.pf_422 = QRadioButton(self.gridLayoutWidget_5)
        self.pixel_format_buttons.addButton(self.pf_422)
        self.pf_422.setObjectName(u"pf_422")
        self.pf_422.setChecked(True)

        self.gridLayout_6.addWidget(self.pf_422, 0, 1, 1, 1)

        self.pf_444 = QRadioButton(self.gridLayoutWidget_5)
        self.pixel_format_buttons.addButton(self.pf_444)
        self.pf_444.setObjectName(u"pf_444")

        self.gridLayout_6.addWidget(self.pf_444, 0, 2, 1, 1)

        self.groupBox_9 = QGroupBox(self.export_tab)
        self.groupBox_9.setObjectName(u"groupBox_9")
        self.groupBox_9.setGeometry(QRect(10, 320, 211, 71))
        self.gridLayoutWidget_6 = QWidget(self.groupBox_9)
        self.gridLayoutWidget_6.setObjectName(u"gridLayoutWidget_6")
        self.gridLayoutWidget_6.setGeometry(QRect(10, 10, 201, 65))
        self.gridLayout_7 = QGridLayout(self.gridLayoutWidget_6)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.pr_3 = QRadioButton(self.gridLayoutWidget_6)
        self.prores_buttons = QButtonGroup(MainWindow)
        self.prores_buttons.setObjectName(u"prores_buttons")
        self.prores_buttons.addButton(self.pr_3)
        self.pr_3.setObjectName(u"pr_3")
        self.pr_3.setChecked(False)

        self.gridLayout_7.addWidget(self.pr_3, 1, 0, 1, 1)

        self.pr__1 = QRadioButton(self.gridLayoutWidget_6)
        self.prores_buttons.addButton(self.pr__1)
        self.pr__1.setObjectName(u"pr__1")
        self.pr__1.setChecked(False)

        self.gridLayout_7.addWidget(self.pr__1, 0, 0, 1, 1)

        self.pr_4 = QRadioButton(self.gridLayoutWidget_6)
        self.prores_buttons.addButton(self.pr_4)
        self.pr_4.setObjectName(u"pr_4")

        self.gridLayout_7.addWidget(self.pr_4, 1, 1, 1, 1)

        self.pr_0 = QRadioButton(self.gridLayoutWidget_6)
        self.prores_buttons.addButton(self.pr_0)
        self.pr_0.setObjectName(u"pr_0")

        self.gridLayout_7.addWidget(self.pr_0, 0, 1, 1, 1)

        self.pr_2 = QRadioButton(self.gridLayoutWidget_6)
        self.prores_buttons.addButton(self.pr_2)
        self.pr_2.setObjectName(u"pr_2")

        self.gridLayout_7.addWidget(self.pr_2, 0, 2, 1, 1)

        self.pr_5 = QRadioButton(self.gridLayoutWidget_6)
        self.prores_buttons.addButton(self.pr_5)
        self.pr_5.setObjectName(u"pr_5")
        self.pr_5.setChecked(True)

        self.gridLayout_7.addWidget(self.pr_5, 1, 2, 1, 1)

        self.tabs.addTab(self.export_tab, "")
        self.image_render_tab = QWidget()
        self.image_render_tab.setObjectName(u"image_render_tab")
        self.horizontalLayoutWidget_6 = QWidget(self.image_render_tab)
        ...
        self.render_scroll_area = QScrollArea(self.image_render_tab)
        ...
        self.tabs.addTab(self.image_render_tab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Rendered Format:", None))
#if QT_CONFIG(tooltip)
        self.rendered_format_edit.setToolTip(QCoreApplication.translate("MainWindow", u"This needs to match the rendered file extension exactly", None))
#endif // QT_CONFIG(tooltip)
        self.rendered_format_edit.setText(QCoreApplication.translate("MainWindow", u"jpg", None))
...
#if QT_CONFIG(tooltip)
        self.groupBox_4.setToolTip(QCoreApplication.translate("MainWindow", u"Note that this is editable and what's used when either Render button is clicked so most if not all ffmpeg settings can be used", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.groupBox_8.setTitle(QCoreApplication.translate("MainWindow", u"Compressioin", None))
        ...
        self.groupBox_5.setTitle(QCoreApplication.translate("MainWindow", u"Pixel Format", None))
        self.alpha.setText(QCoreApplication.translate("MainWindow", u"Include Alpha", None))
#if QT_CONFIG(tooltip)
        self.color_10_bit.setToolTip(QCoreApplication.translate("MainWindow", u"For H.264, 10 bit is only available if your version of ffmpeg is set up for it", None))
#endif // QT_CONFIG(tooltip)
        self.color_10_bit.setText(QCoreApplication.translate("MainWindow", u"10 bit Color", None))
        self.pf_420.setText(QCoreApplication.translate("MainWindow", u"4:2:0", None))
        self.pf_422.setText(QCoreApplication.translate("MainWindow", u"4:2:2", None))
        self.pf_444.setText(QCoreApplication.translate("MainWindow", u"4:4:4", None))
        self.groupBox_9.setTitle(QCoreApplication.translate("MainWindow", u"ProRes Profile (optional)", None))
        self.pr_3.setText(QCoreApplication.translate("MainWindow", u"HQ", None))
        self.pr__1.setText(QCoreApplication.translate("MainWindow", u"Auto", None))
        self.pr_4.setText(QCoreApplication.translate("MainWindow", u"4444", None))
        self.pr_0.setText(QCoreApplication.translate("MainWindow", u"Proxy", None))
        self.pr_2.setText(QCoreApplication.translate("MainWindow", u"Standard", None))
        self.pr_5.setText(QCoreApplication.translate("MainWindow", u"4444xp", None))
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.image_render_tab), QCoreApplication.translate("MainWindow", u"Image Render", None))
